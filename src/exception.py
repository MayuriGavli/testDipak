...
def error_message_detail(error_msg,error_detail:sys):       #error_msg: This is a string that represents the actual error message , error_detail: sys: This expects the sys module
    ...
    file_name = exc_tb.exc_frame.f_code.co_file_name # Refers to the current stack frame where the exception occurred. f_code.co_filename: Retrieves the name of the file in which the error occurred.
